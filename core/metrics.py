...
def ssim_fn(x, y): # x, y: [H,W,3], range: [0,1]?? see issues on the github
    return structural_similarity(x, y, multichannel=True, channel_axis=-1, data_range=1.0) # HB: fixed channel_axis
